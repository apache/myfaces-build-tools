...
public class ASTBitwiseANDExpressionNoIN extends SimpleNode
{
  public ASTBitwiseANDExpressionNoIN(int id)
  {
    super(id);
  }

  public ASTBitwiseANDExpressionNoIN(JSParser20 p, int id)
  {
    super(p, id);
  }
