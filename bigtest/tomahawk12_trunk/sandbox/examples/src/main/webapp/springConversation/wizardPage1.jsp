...
<h:panelGrid columns="2">
    ...
    <h:selectOneMenu value="#{springWizardData.salutation}" required="true">
    	<f:selectItem itemValue="Mr."/>
    	<f:selectItem itemValue="Mrs."/>
    </h:selectOneMenu>

    <h:outputText value="Title: " />
    <h:inputText id="stree" value="#{springWizardData.title}" />

    <h:outputText value="Name: " />
    <h:inputText id="name" value="#{springWizardData.name}" required="true"/>

    <h:outputText value="Surename: " />
    <h:inputText id="surename" value="#{springWizardData.surename}" required="true"/>
