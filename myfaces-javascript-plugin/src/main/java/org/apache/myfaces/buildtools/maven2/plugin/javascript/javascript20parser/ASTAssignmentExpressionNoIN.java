...
public class ASTAssignmentExpressionNoIN extends SimpleNode
{
  public ASTAssignmentExpressionNoIN(int id)
  {
    super(id);
  }

  public ASTAssignmentExpressionNoIN(JSParser20 p, int id)
  {
    super(p, id);
  }
